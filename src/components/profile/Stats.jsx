	...
	return (
		<section aria-label="User statistics">
			<div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
				{/* Favorite genres */}
				<article className="bg-green-100 rounded-lg p-4 text-center">
					<svg
				...
				<article className="bg-orange-100 rounded-lg p-4 text-center">
					<svg
						xmlns="http://www.w3.org/2000/svg"
						fill="none"
						viewBox="0 0 24 24"
				...
				<article className="bg-blue-100 rounded-lg p-4 text-center">
					<svg
						xmlns="http://www.w3.org/2000/svg"
						fill="none"
						viewBox="0 0 24 24"
